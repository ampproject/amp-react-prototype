...
function Img() {
  return /*#__PURE__*/react.createElement("span", null, "Img");
}

function HeavyProto(_ref2) {
  var placeholder = _ref2.placeholder,
      showWarning = _ref2.showWarning,
      rest = _objectWithoutProperties(_ref2, ["placeholder", "showWarning"]);

  return /*#__PURE__*/react.createElement("div", _extends({}, rest, {
    className: "heavy",
    style: {
      border: "1px solid ".concat(showWarning ? 'red' : 'black')
    }
  }), "Heavy: ", placeholder);
}

var Heavy = withWrapper(HeavyProto);

function Sparse(_ref) {
  var el = _ref.el,
      sid = _ref.sid,
      skipContent = _ref.skipContent,
      children = _ref.children,
      getComponent = _ref.getComponent,
      rest = _objectWithoutProperties(_ref, ["el", "sid", "skipContent", "children", "getComponent"]);
  ...
  react.useEffect(function () {
    if (getComponent) {
      return onFakeUnblock(function () {
        return getComponent().then(setComponent);
      });
    }
  }, [getComponent]);
  ...
  return /*#__PURE__*/react.createElement(El, _extends({
    ...
    dangerouslySetInnerHTML: skipContent ? {
      __html: ''
    } : null,
...
function onFakeUnblock(callback) {
  if (!window.__blocker) {
    window.__blocker = new Promise(function (resolve) {
  ...
  window.__blocker.then(function () {
    if (!canceled) {
      callback();
    }
  });
...
function Doc() {
  ...
  return /*#__PURE__*/react.createElement(Sparse, {
    el: "x-html"
  }, /*#__PURE__*/react.createElement(Sparse, {
    el: "x-head",
    skipContent: true
  }), /*#__PURE__*/react.createElement(Sparse, {
    el: "x-body"
    ...
    getComponent: function getComponent() {
      // var promise = import('./index-6f60d445.js');
      var promise = Promise.resolve({'Heavy': Heavy});
      return promise.then(function (module) {
        return module['Heavy'];
      }).then(function (Comp) {
        return /*#__PURE__*/react.createElement(Comp, {
          placeholder: /*#__PURE__*/react.createElement(Img, null),
...
reactDom.hydrate( /*#__PURE__*/react.createElement(Doc, null), document.body);
