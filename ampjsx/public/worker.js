var WorkerThread = (function (exports) {
    ...
    /* allowTransfer */
      ...
      Promise.resolve().then(function (_) {
        if (pending) {
          ...
          /* type */
          , 3), _defineProperty(_document$postMessage, 37
          /* nodes */
  ...
  */
  ...
  function (_ParentNode) {
    ...
    function Element(nodeType, localName, namespaceURI, ownerDocument) {
      var _this;

      _classCallCheck(this, Element);

      _this = _super.call(this, nodeType, toUpper(localName), ownerDocument);
      _this.attributes = [];
      _this[_a$4] = {};
  ...
  */
  ...
  function (_HTMLElement) {
    ...
    function HTMLIFrameElement() {
      ...
      _this = _super.apply(this, arguments); // HTMLIFrameElement.sandbox, DOMTokenList, reflected attribute
  ...
  function (_HTMLElement) {
    ...
    function HTMLOptionElement(nodeType, localName, namespaceURI, ownerDocument) {
      ...
      _this = _super.call(this, nodeType, localName, namespaceURI, ownerDocument);
      _this[_a$6] = false;
      _this[46
      /* propertyBackedAttributes */
      ].selected = [function () {
  ...
  function (_Node) {
    ...
    function CharacterData(data, nodeType, nodeName, ownerDocument) {
      var _this;

      _classCallCheck(this, CharacterData);

      _this = _super.call(this, nodeType, nodeName, ownerDocument);
      _this[38
      /* data */
      ] = data;
      _this[8
  ...
  function (_Element) {
    ...
    function Document(global) {
      ...
      _this.observe = function () {
        ...
        propagate$1(_this.defaultView);
        propagate$2();
        propagate$3(_this.defaultView);
  ...
  function create(document, strings, skeleton) {
    ...
    /* nodeType */
      ...
      default:
        ...
        var name = strings[skeleton[1
        /* localOrNodeName */
        ]];
        var node = namespace ? document.createElementNS(namespace, name) : document.createElement(name);
        (skeleton[2
        /* attributes */
